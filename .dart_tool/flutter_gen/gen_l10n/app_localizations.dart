...
abstract class AppLocalizations {
  ...
  /// No description provided for @password_length_rule.
  ///
  /// In en, this message translates to:
  /// **'8 characters or more (no spaces)'**
  String get password_length_rule;

  /// No description provided for @password_case_rule.
  ///
  /// In en, this message translates to:
  /// **'Uppercase and lowercase letters'**
  String get password_case_rule;

  /// No description provided for @password_number_rule.
  ///
  /// In en, this message translates to:
  /// **'At least one digit '**
  String get password_number_rule;
